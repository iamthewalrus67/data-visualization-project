...
function createVisualization(exportsData, yieldData) {
    ...
    const cropColors = {
        'Wheat': '#FFD700',        // Gold
        'Barley': '#B8860B',       // Dark goldenrod
        'Corn': '#FFA500',         // Orange
        'Millet': '#9ACD32',       // Yellow-green
        'Oats': '#DEB887',         // Burlywood
        'Rye': '#8B4513',          // Saddle brown
        'Rice, Milled': '#E1C699', // Light tan (no white)
        'Sorghum': '#A0522D',      // Sienna
        // Add more crops and colors as needed, avoid white/grey
    };
